...
## 3.1. Use Case 1: Boxplots of z-cores for a given gene across different drugs, grouped by cell lines and perturbagen classes
...
## 3.2. Use Case 2: Plot the number of times that a compound up and down modulate genes, across all cell lines
...
## 3.3. Use Case 3: Plot heatmap of differential expression 
